...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{figure}
		\centering
		\includegraphics[width=0.7\textwidth]{figures/gsfig.jpg}
		\caption{Image 3}
		% \vspace*{\fill}
		% \includegraphics[width=0.9\textwidth]{figures/facility.pdf}
		% \caption{Image 1}
	\end{figure}
	\column{0.5\textwidth}
	\begin{figure}
		\centering
		\includegraphics[width=0.8\textwidth]{figures/ISOLDE-experimental-hall.jpg}
		\caption{Image 2}
		\end{figure}
	\end{columns}
\end{frame}
