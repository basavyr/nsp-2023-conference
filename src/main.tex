...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{figure}
		\centering
		\includegraphics[width=0.9\textwidth]{figures/gsfig.jpg}
		\caption{Gammasphere detector, ANL USA. \textit{Source: aps.org}}
	\end{figure}
	\column{0.6\textwidth}
	\begin{figure}
		\centering
		\includegraphics[width=0.9\textwidth]{figures/isolde_cern_2.jpg}
		\caption{IDS detector, CERN. \textit{Source: mediaarchive.cern.ch}}
		\end{figure}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\begin{block}{Searching for evidence \faSearch}
		\begin{itemize}
	...
	\begin{alertblock}{Experimental observations \faSearch}
		First experimental evidence for nuclear wobbling motion in 2001.
	\end{alertblock}
\end{frame}
